...
@Specializes
public class MockAwareApplicationScopeBean extends ApplicationScopedBean
{
    private ApplicationScopedBean mockedApplicationScopedBean;
    ...
    protected void onMockRegistrationEvent(@Observes MockRegistrationEvent mockRegistrationEvent)
    {
        ...
        {
            this.mockedApplicationScopedBean = mockRegistrationEvent.getMockInstance(ApplicationScopedBean.class);
        }
    }
    ...
    {
        return mockedApplicationScopedBean.getValue();
    }
}
